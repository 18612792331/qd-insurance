package com.qding.api.rongcloud.util;

import com.qding.api.rongcloud.model.SdkHttpResult;
...
public final class HttpUtil {
    ...
    public static HttpURLConnection CreatePostHttpConnection(String appKey,
                                                             String appSecret, String uri) throws Exception {
    ...
    public static String returnResultStr(HttpURLConnection conn) throws Exception{
        ...
        if (conn.getResponseCode() == 200) {
            input = conn.getInputStream();
            return new String(readInputStream(input));
        } else {
            return null;
        }
    }
