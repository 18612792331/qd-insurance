...
public class Lunar {
    ...
    public static  List<DateDTO>  getDatesForMonth(int year, int month) {

        int dayCount = getDaysByYearMonth(year, month);
        SimpleDateFormat myFormatter = new SimpleDateFormat("yyyy-MM-dd");
        List<DateDTO> dateList = Lists.newArrayList();
        for (int i = 1; i <= dayCount; i++) {
            ...
            try {
                ...
                l.isSFestival();
                l.isLFestival();
                String solarMonth = String.valueOf(l.getSolarMonth());
                String solarDay = String.valueOf(l.getSolarDay());
                if (l.getSolarMonth() < 10) {
                ...
                DateDTO dateDTO = new DateDTO(String.valueOf(l.getSolarYear()), solarMonth, solarDay,
                        l.getLunarYearString(), l.getLunarMonthString(), l.getLunarDayString(), l.getTermString(), l.getCyclicalDateString(), l.getLFestivalName(), l.getSFestivalName(), dateStr,l.getDayOfWeek());
    ...
    public static DateDTO getCurDay(){
        ...
        try {
            ...
            if (l.getSolarDay() < 10) {
             ...
             dateDTO = new DateDTO(String.valueOf(l.getSolarYear()), solarMonth, solarDay,
                    l.getLunarYearString(), l.getLunarMonthString(), l.getLunarDayString(), l.getTermString(), l.getCyclicalDateString(), l.getLFestivalName(), l.getSFestivalName(), dateStr,l.getDayOfWeek());
    ...
    public static void main(String[] args) {
        getDatesForMonth(2017, 2);
/*
        SimpleDateFormat myFormatter = new SimpleDateFormat("yyyy-MM-dd");


        try {
            date = myFormatter.parse("2017-3-5");
        ...
        System.out.println(l.isSFestival());
        System.out.println(l.getSFestivalName());
...
//  }
     ...
     * @return 农历字符串(例:甲子年正月初三)
     */
    public String getLunarDateString_sky() {
        if (this.lunarDay < 10) {
