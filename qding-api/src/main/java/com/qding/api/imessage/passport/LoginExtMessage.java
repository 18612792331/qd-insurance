...
public class LoginExtMessage {
    ...
    private Logger logger = Logger.getLogger(LoginExtMessage.class);
    ...
    public void addLoginExt(LoginExtMessageParams params){
        try {
            ...
            msginfoRequest.setName("AddloginExtMessage");
            ...
            msginfoRequest.setTopicName("addLoginExt");
            MsginfoResponse msginfoResponse = remoteJobService.SendImessage(msginfoRequest);
            logger.info("addLoginExt Imessage Response code:"+msginfoResponse.getReturnInfo().getCode()+"," +
