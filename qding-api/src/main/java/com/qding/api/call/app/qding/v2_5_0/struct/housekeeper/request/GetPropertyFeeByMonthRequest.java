...
@Validate
public class GetPropertyFeeByMonthRequest extends BaseRequest {
    ...
    //0 全部 1未缴
    @NotNullValidate
    @ExplainAnnotation(explain = "查询类型", desc = "0：全部 | 1：未缴")
    ...
    public GetPropertyFeeByMonthRequest() {

    }

    public GetPropertyFeeByMonthRequest(Integer pageSize, Integer pageNo, String roomId, String memberId, Integer feeStatus) {
        super();
