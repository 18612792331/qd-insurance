 ...
 */
@Validate
public class GetNearbyTopicsByProjectIdRequest extends BaseRequest {

    private static final long serialVersionUID = -7205502149329906022L;
    ...
    public String toString() {
        return "GetNearbyTopicsByProjectIdRequest{" +
                "pageNo=" + pageNo +
                ", pageSize=" + pageSize +
