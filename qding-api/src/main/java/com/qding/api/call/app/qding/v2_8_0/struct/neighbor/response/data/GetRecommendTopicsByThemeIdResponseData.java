 ...
 */
public class GetRecommendTopicsByThemeIdResponseData extends ResponseData {


    private static final long serialVersionUID = 4721998368988067840L;
    ...
    public String toString() {
        return "GetRecommendTopicsByThemeIdResponseData{" +
                "topicList=" + topicList +
                ", themeInfo=" + themeInfo +
