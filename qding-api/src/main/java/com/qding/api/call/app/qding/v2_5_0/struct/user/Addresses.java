package com.qding.api.call.app.qding.v2_5_0.struct.user;
...
public class Addresses {
    ...
    @ExplainAnnotation(explain = "社区街道地址", desc = "2.5版本新增")
    ...
    @ExplainAnnotation(explain = "api内部使用",desc="2.5版本新增")
    private Integer version;
    
    @ExplainAnnotation(explain = "组团id",desc="2.8版本新增")
    private String groupId;
    
    @ExplainAnnotation(explain = "组团名称",desc="2.8版本新增")
    private String groupName;
    
    @ExplainAnnotation(explain = "组团街道地址",desc="2.8版本新增")
