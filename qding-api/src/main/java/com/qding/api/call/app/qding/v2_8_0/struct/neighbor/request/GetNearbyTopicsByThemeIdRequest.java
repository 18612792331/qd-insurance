 ...
 */
@Validate
public class GetNearbyTopicsByThemeIdRequest extends BaseRequest {


    private static final long serialVersionUID = 7619014976355659481L;
    ...
    public String toString() {
        return "GetNearbyTopicsByThemeIdRequest{" +
                "themeId='" + themeId + '\'' +
                ", pageNo=" + pageNo +
                ", pageSize=" + pageSize +
