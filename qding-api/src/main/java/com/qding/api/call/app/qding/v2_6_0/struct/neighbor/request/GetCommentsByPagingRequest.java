 ...
 */
@Validate
public class GetCommentsByPagingRequest extends BaseRequest {

    private static final long serialVersionUID = 4486888667991851283L;
    ...
    public String toString() {
        return "GetCommentsByPagingRequest{" +
                "topicId='" + topicId + '\'' +
                ", pageNo=" + pageNo +
                ", pageSize=" + pageSize +
                '}';
