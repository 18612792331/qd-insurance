 ...
 *
 */
@XStreamAlias(value="activityBanner")
public class ActivityBanner implements Serializable{
	...
	public String toString() {
		return "CycleBanner [id=" + id + ", title=" + title + ", type=" + type
				...
				+ createAt + ", url=" + url + ",bigUrl="+bigUrl+"]";
	}

	public ActivityBanner(long id, String title, int type, int noticeType,
						  String content, String pic, int position, long createAt, String url,String bigUrl) {
		super();
		this.id = id;
		this.title = title;
		this.type = type;
