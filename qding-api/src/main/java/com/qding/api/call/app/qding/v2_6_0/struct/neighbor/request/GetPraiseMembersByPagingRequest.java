 ...
 */
@Validate
public class GetPraiseMembersByPagingRequest extends BaseRequest {

    private static final long serialVersionUID = 6114510383067055489L;
    ...
    public String toString() {
        return "GetAllPraiseByTopicIdRequest{" +
                "topicId='" + topicId + '\'' +
                ", pageNo=" + pageNo +
                ", pageSize=" + pageSize +
                '}';
