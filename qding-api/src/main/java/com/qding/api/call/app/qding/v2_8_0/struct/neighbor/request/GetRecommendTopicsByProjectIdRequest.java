 ...
 */
@Validate
public class GetRecommendTopicsByProjectIdRequest extends BaseRequest {

    private static final long serialVersionUID = -7336824865886739164L;
    ...
    public String toString() {
        return "GetRecommendTopicsByProjectIdRequest{" +
                "pageNo=" + pageNo +
                ", pageSize=" + pageSize +
