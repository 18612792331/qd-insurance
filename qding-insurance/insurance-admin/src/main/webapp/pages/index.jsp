...
<%
    ...
    if (env.equalsIgnoreCase("boss") || env.equalsIgnoreCase("qd")) { //boss后台
        ...
        frontBranch = "finance";
    }else if(env.startsWith("//localhost") || env.startsWith("127")){
        staticHost = "//localhost";


    }
    System.out.println(frontBranch);
...
<head>
    ...
    <link rel="stylesheet" href="<%=staticHost %>/<%=frontBranch %>/css/base.min.css?<%=version %>" />
    <link rel="stylesheet" href="<%=staticHost %>/<%=frontBranch %>/css/insurance.min.css?<%=version %>" />
    ...
    <script src="<%=staticHost %>/public/ueditor/ueditor.config.js"></script>
    <script src="<%=staticHost %>/public/ueditor/ueditor.all.min.js"></script>
    <script src="<%=staticHost %>/public/ueditor/upload.js"></script>
    <script src="<%=staticHost %>/public/ueditor/goodseditor.js"></script>
    <script src="<%=staticHost %>/public/angular-ueditor/dist/angular-ueditor.min.js"></script>
    <script src="<%=staticHost %>/<%=frontBranch %>/js/insurance.min.js?<%=version %>"></script>
</head>
<body cs-layout></body>
</html>